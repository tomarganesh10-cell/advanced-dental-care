...
| Implant systems: Nobel Biocare, Straumann, Osstem              | Purchase invoices or distributor confirmation that these are _currently_ stocked                                                                | `NEEDS_VERIFICATION`                                                                                                         |
...
| Digital Smile Design                                           | Whether the clinic is DSD-certified, or simply performs digital smile _planning_. These are different claims — "DSD" is a trademarked programme | `NEEDS_VERIFICATION`                                                                                                         |
...
- **No price-led solicitation** framed as an inducement ("lowest cost implants",
  "50% off"). Transparent price _ranges_ on a treatment page are fine.

...
export const ROLE_PERMISSIONS: Record<StaffRoleName, Permission[]> = {
  ...
  CLINIC_ADMIN: [
    ...
    P.APPOINTMENT_COMPLETE,
    P.APPOINTMENT_ASSIGN_DOCTOR,
    P.PATIENT_VIEW,
    P.PATIENT_CREATE,
    P.PATIENT_UPDATE,
    P.PATIENT_EXPORT,
    ...
    P.CONTENT_EDIT,
    P.CONTENT_PUBLISH,
    P.CONTENT_VERIFY_CLAIMS,
    P.BLOG_MANAGE,
    P.GALLERY_MANAGE,
    P.TESTIMONIAL_MANAGE,
    P.FEEDBACK_VIEW,
    P.FEEDBACK_HANDLE,
    P.NOTIFICATION_VIEW,
